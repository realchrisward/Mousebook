...
if (isset($_POST['generate_litter'])) {
	...
	//populate table
	if ($xdob == "") {
		$testtable = "<p style=\"color:#b00020;font-weight:bold;\">A date of birth is required. Please enter the litter's date of birth (or click the Today button) and generate again. No litter was recorded.</p>";
	} else {
	...
	<div id="right_content" class="centertext">
		<form id="add_animals_form" name="add_animals_form" method=post>
			...
			<table>
				...
				<tr>
					<td><input type=date id="dob" name="dob" value="<?php echo $dob; ?>"><input type=button value="Today" title="Fill in today's date" style="margin-left:6px" onclick="var d=new Date();document.getElementById('dob').value=d.getFullYear()+'-'+String(d.getMonth()+1).padStart(2,'0')+'-'+String(d.getDate()).padStart(2,'0');"></td>
				</tr>
				<tr>
					<th>Comments:</th>
				</tr>
