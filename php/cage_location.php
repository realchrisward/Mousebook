...
$conn=new mysqli($host,$accessun,$accesspw,$dbname);
$sqltext="SELECT * FROM mousebook.list_cage_locations";
$results=$conn->query($sqltext);
//set up static portion of table
...
//echo $cageselection;
$sqltext="UPDATE `mousebook`.`table_cages` SET `cagelocation_room`='".$locationB_selection."' WHERE `cageid` in ".$cageselection.";";
//echo $sqltext;
